        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                                ...
                                <nav class="sidebar-nav">
                                    ...
                                    <ul id="sidebarnav">
                                        ...
                                        if ($c['level'] == "superadmin") {
                                            ...
                                            <li class="sidebar-item"> 
                                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="?page=provider_api" aria-expanded="false">
                                                    <i class="ti-settings"></i>
                                                    <span class="hide-menu">Provider API</span>
                                                </a>
                                            </li>
                                            <?php
                                        }
                ...
                //Banner
                              ...
                              }else if ($_GET['page'] == "provider_api") {
                                  include 'page/provider_api.php';
