            ...
            ?>
              ...
              <div class="header-form">
                <form name="login-form" action="function/cek_login.php" method="POST">
                  <input value="" name="username" type="text" placeholder="Username*" autocomplete="off" required>
                  <input value="" name="password" type="password" placeholder="Password*" autocomplete="off" required>
                  <button name="submit" type="submit" class="button-login">Login</button>
                </form>
                <a id="register" href="?page=daftar" class="btn-daftar">Register</a>
              </div>
            <?php
            } else {
            ?>
              <div class="header-user">
                ...
                <div class="user-wallet ml-1">
                  ...
                  <a class="wallet-amount" id="wallet-amount" href="#" data-toggle="modal" data-target="#accountBalance">
                    INR
                    <span id="mainBalance" name="mainBalance">₹<?php echo format_indian_currency($liat['active']); ?></span>
                  </a>
                </div>
              </div>
              <div class="header-form mb-2">
                <a class="btn-profil " href="?page=profile">Profile</a>
                <a class="btn-transaksi " href="?page=transaksi">Transaction</a>
                <a class="btn-transaksi " href="?page=refferal">Referral</a>
                <a class="btn-signout" href="function/logout.php">Logout</a>
              </div>
          </div>
        </div>
      <?php
      ...
      $.ajax({
        ...
        error: function(xhr, status, error) {
          ...
          Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Balance withdrawal failed.',
    ...
    ?>
      <script type="text/javascript">
        Swal.fire({
          icon: 'info',
          title: 'Warning',
          text: 'Game is currently under maintenance!'
        });
      </script>
  <?php
    }
