    ...
    <div class="main-content slot-game">
        <div class="container">
            <div class="slot-game__container">
                <div class="page-header">DreamTech</div>
                <div class="slot-game-list">
                    ...
                    $games_query = mysqli_query($koneksi, "SELECT * FROM tb_gamelist WHERE provider = 'DREAMTECH'");
                        ...
                        if (isset($_SESSION['username'])) {
                            ...
                            if ($cek > 0) {
                                ...
                                if ($id_login == '') {
                                    ...
                                    $link_url = $urlweb . '/main/API/playGame.php?extplayer='.$extplayer.'&gameCode='.$data['gameid'].'&provider='.'DREAMTECH';
                                }
